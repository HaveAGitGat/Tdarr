...
import {StatisticsDB} from '../api/tasks.js';
...
class App extends Component {
  ...
  renderPie(pie, property, fileMedium) {
    var statistics = this.props.statistics;
    let data = [{name: 'Loading...', value: 1}];

    if (statistics.length !== 0) {
      data = statistics[0][pie];
    }
            ...
            <table>
              <tbody>
                <tr>
                  ...
                  <td>
                    <p>
                      ...
                      {'\u00A0'}
                      {'\u00A0'}
                      {this.renderStat('totalFileCount')}
                    </p>
                  </td>
                </tr>
                ...
                <tr>
                  <td>
                    <p>
                      <b>Total number of transcodes</b>
                    </p>
                  </td>
                  <td>
                    <p>
                      ...
                      {'\u00A0'}
                      {'\u00A0'}
                      {this.renderStat('totalTranscodeCount')}
                    </p>
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  <td>
                    <p>
                      <b>Total number of health checks</b>
                    </p>
                  </td>
                  <td>
                    {' '}
                    <p>
                      ...
                      {'\u00A0'}
                      {'\u00A0'}
                      {this.renderStat('totalHealthCheckCount')}
                    </p>
                  </td>
                </tr>
