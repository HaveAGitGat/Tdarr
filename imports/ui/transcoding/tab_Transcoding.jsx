...
class App extends Component {
  ...
  setAllStatus(mode, table, processStatus, text) {
    if (confirm(`Are you sure you want to ${text} all files?`)) {
      Meteor.call("setAllStatus", "all", mode, table, processStatus, function (
        error,
        result
      ) {});
    }
            ...
            <div className="sliderGrid-container">
              ...
              <div className="sliderGrid-item1">
                <p>
                  ...
                  this.props.globalSettings[0] &&
                  this.props.globalSettings[0].generalWorkerLimit
                    ? this.props.globalSettings[0].generalWorkerLimit
                    : 0}
                  )
                </p>
              ...
              <div className="sliderGrid-item1">
                <p>
                  ...
                  {this.props.globalSettings &&
                  this.props.globalSettings[0] &&
                  this.props.globalSettings[0].transcodeWorkerLimit
                    ? this.props.globalSettings[0].transcodeWorkerLimit
                    : 0}
                  )
                </p>
              ...
              <div className="sliderGrid-item1">
                <p>
                  ...
                  {this.props.globalSettings &&
                  this.props.globalSettings[0] &&
                  this.props.globalSettings[0].healthcheckWorkerLimit
                    ? this.props.globalSettings[0].healthcheckWorkerLimit
                    : 0}
                  )
                </p>
                    ...
                    if (
                      ...
                      Meteor.call("getWorkers", function (error, result) {
                        ...
                        for (var i = 0; i < workers.length; i++) {
                          Meteor.call("killWorker", workers[i]._id, function (
                            error,
                            result
                          ) {});
                        }
          ...
          <p>
            ...
            <input
              ...
              defaultValue={
                this.props.globalSettings &&
                this.props.globalSettings[0] &&
                this.props.globalSettings[0].tableSize
                  ? this.props.globalSettings[0].tableSize
                  : ""
              }
              onChange={(event) => {
                    ...
                    <tr>
                            ...
                            <div className="modalContainer">
                              <div className="frame">
                                <div className="scroll">
                                  <div className="modalText">
                                    <p>
                                      All new plugins created in v1.101 will
                                      have a new force processing switch which
                                      overrides filters (or you'll need to
                                      modify existing plugins).
                                    </p>

                                    <p>
                                      It will allow for the FIRST plugin's
                                      filter in the plugin stack to be
                                      overridden. So you need to have your main
                                      transcode plugin at the top of your stack.
                                    </p>
                                    <p></p>
                                    <p>So a typical stack might look like:</p>
                                    <p></p>
                                    <p>
                                      (1) Transcode using HandBrake into h264
                                      (Exclude files already in h264)
                                    </p>
                                    <p>(2) Remove subs</p>
                                    ...
                                    <p></p>
                                    <p>
                                      Force processing will force the HandBrake
                                      transcode plugin on a file (even if it's
                                      already in h264) and then the status for
                                      force processing is reset to off.
                                    </p>
                                  </div>
                                </div>
                              </div>
                      ...
                      <th>
                        <p>
                          ...
                          >
                            <span className="buttonTextSize">Skip</span>
                          </Button>
                        </p>
                      </th>
                    </tr>
