...
`}
            ...
            <div
              className={this.props.worker.percentage <= 100 ? '' : 'hidden'}
            >
              <Progress
            ...
            <div className={this.state.infoHidden ? 'hidden' : ''}>
              <table className="workerDetailTable">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <p>{this.transcodeReason(this.props.worker.cliLogAdd)}</p>
                    </td>
                  </tr>
              ...
              <center>
                <Button
                  ...
                  style={ButtonStyle}
                  onClick={() => {
                    Meteor.call('cancelWorkerItem', this.props.worker._id);
                  }}
                >
