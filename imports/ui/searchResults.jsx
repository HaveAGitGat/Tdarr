...
export default class App extends Component {
...

        {
          ...
          accessor: row =>
            row.TranscodeDecisionMaker == 'Queued'
              ...
              : this.renderRedoButton(row.file, 'TranscodeDecisionMaker'),
          getProps: () => {
            return {
              style: {
                color: '#e1e1e1',
...

        {
          ...
          accessor: row =>
            row.HealthCheck == 'Queued'
              ...
              : this.renderRedoButton(row.file, 'HealthCheck'),
          getProps: () => {
            return {
              style: {
                color: '#e1e1e1',
  ...
  renderInfoButton(row) {
    ...
    result = result.map((row, i) => <p key={`row-${row}-${i}`}>{row}</p>);
