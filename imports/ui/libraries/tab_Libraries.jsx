      ...
      if (this.props.libraries.length == 0) {
        ...
        return (
          <div className="tabWrapLib">
            ...
            <Tabs
              selectedIndex={
                this.state.selectedLibrary != undefined
                ...
                <div className="frame">
                  <div className="scroll">
                    <div className="modalText">
                      <p>
                        Tdarr is designed to automatically manage transcoding
                        and health checking of your media libraries. If you've
                        used HBBatchBeast, a lot of the settings will look
                        familiar.
                      </p>
                      ...
                      <p>
                        ...
                        the container types you'd like to scan for and then
                        click then click 'Scan (Fresh)' on the Options dropdown.
                        This will do a fresh scan of the library and extract
                        property data from files which fit your specified
                        container settings. The data will then be saved in the
                        database.
                      </p>
                      ...
                      <p>
                        ...
                        process. New files will be scanned for every 30 seconds
                        or so.
                      </p>
                      <p>
                        All new files will be added to both the transcode queues
                        and the health check queues. If you're not interested in
                        using one or the other, then just make sure not to fire
                        up any workers for that respective queue.
                      </p>

                      <p></p>
                      <p>
                        If the 'Scan on start' option is turned on, Tdarr will
                        scan the library on start-up and then scan the library
                        daily.
                      </p>
                      <p></p>
                      <p></p>
                      ...
                      <p>
                        You can stack plugins but this will increase the number
                        of transcode/remux passes on a file. It's best to
                        use/create a plugin which can do what you need all at
                        once.
                      </p>
                      ...
                      <p>
                        See the plugins tab for plugins info on creating a
                        plugin.
                      </p>
                      ...
                      <p>
                        Please see the following for help with creating FFmpeg
                        commands:
                      </p>
                      ...
                      <p>
                        --preset-import-file
                        "C:/Users/HaveAGitGat/Desktop/testpreset.json" -Z "My
                        Preset"
                      </p>
                      ...
                      <p>
                        ...
                        HandBrakeCLI (will be fixed in next HandBrakeCLI
                        release).
                        <a
                          href=""
                          onClick={(e) => {
                      ...
                      <p></p>
                      <p>
                        Regarding the transcode filter settings, these are
                        applied when the items are being processed in the
                        transcode queue. If files do not meet the transcode
                        requirements then they will be marked as 'Transcode:Not
                        required'.
                      </p>
