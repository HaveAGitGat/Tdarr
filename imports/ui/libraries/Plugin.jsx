...
<span className="buttonTextSize">{'\u00A0'}{'\u00A0'}{this.props.pluginItem.priority != undefined ? this.props.pluginItem.priority + 1 : "-"} {'\u00A0'}{'\u00A0'}</span>
      ...
      <div className="pluginStackCol1"><button className="deleteCodecButton" onClick={this.deleteThisPlugin.bind(this)}>
