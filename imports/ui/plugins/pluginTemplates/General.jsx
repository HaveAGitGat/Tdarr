...
export default class App extends Component {
  ...
  renderConditionals = () => {
    ...
    return <div className="pluginSummaryDetailsGrid2">{conditionals}</div>;
  };
  ...
  createPlugin = () => {
    ...
    for (var i = 0; i < conditionals.length; i++) {
      conditionalsString +=
        " &&" + conditionals[i].filter + ".outcome === true";
      ...
      <div>
        ...
        <div className="pluginSummary">
          ...
          <div className="pluginSummaryDetailsGrid">
            ...
            <div>
              <p>{this.state.details.Type}</p>
            </div>
            <div>
              <p>Operation</p>
            </div>
            <div>
              <p>{this.state.details.Operation}</p>
            </div>
            <div>
              <p>Description</p>
            </div>
        ...
        <center>
          <Button variant="outline-light" onClick={this.createPlugin}>
            Create Plugin
          </Button>
        </center>
        ...
        <h3
          ...
          className={
            this.state.selectedDropdown == "pluginDetails"
              ? "selectedNav"
              : "unselectedNav"
          }
        >
        ...
        <h3
          ...
          className={
            this.state.selectedDropdown == "addFilters"
              ? "selectedNav"
              : "unselectedNav"
          }
        >
        ...
        <h3
          ...
          className={
            this.state.selectedDropdown == "setAction"
              ? "selectedNav"
              : "unselectedNav"
          }
        >
        ...
        <div
          className={
            this.state.selectedDropdown == "pluginDetails" ? "" : "d-none"
          }
        >
          <br />

          <p>
            These details are purely descriptive. They have no effect on how
            files are processed.
          </p>
        ...
        <div
          className={
            this.state.selectedDropdown == "addFilters" ? "" : "d-none"
          }
        >
          <center>
            <p>Filters:</p>{" "}
          ...
          <center>
            {" "}
            <select ref="filterDropdown" onChange={this.setShownFilter}>
          ...
          <div
            className={
              this.state.selectedFilter == "filterByMedium" ? "" : "d-none"
            }
          >
          ...
          <div
            className={
              this.state && this.state.selectedFilter == "filterByCodec"
                ? ""
                : "d-none"
            }
          >
          ...
          <div
            className={
              this.state && this.state.selectedFilter == "filterByAge"
                ? ""
                : "d-none"
            }
          >
          ...
          <div
            className={
              this.state && this.state.selectedFilter == "filterByResolution"
                ? ""
                : "d-none"
            }
          >
          ...
          <div
            className={
              this.state && this.state.selectedFilter == "filterBySize"
                ? ""
                : "d-none"
            }
          >
        ...
        <div
          className={this.state.selectedDropdown == "setAction" ? "" : "d-none"}
        >
          <center>
            {" "}
            <p>Actions:</p>
          ...
          <center>
            {" "}
            <select ref="actionDropdown" onChange={this.setShownAction}>
              <option value="transcodeHandBrakeBasic">
                Transcode - HandBrake basic options
              </option>
              <option value="transcodeCustom">
                Transcode - HandBrake/FFmpeg custom arguments
              </option>
              <option value="transcodeStandardiseAudioCodecs">
                Transcode - Standardise audio stream codecs
              </option>
              <option value="transcodeAddAudioStream">
                Transcode - Add audio stream
              </option>
              <option value="transcodeKeepOneAudioStream">
          ...
          <div
            className={
              this.state && this.state.selectedAction == "transcodeCustom"
                ? ""
                : "d-none"
            }
          >
          ...
          <div
            className={
              this.state &&
              this.state.selectedAction == "transcodeHandBrakeBasic"
                ? ""
                : "d-none"
            }
          >
          ...
          <div
            className={
              this.state &&
              this.state.selectedAction == "transcodeStandardiseAudioCodecs"
                ? ""
                : "d-none"
            }
          >
          ...
          <div
            className={
              this.state &&
              this.state.selectedAction == "transcodeAddAudioStream"
                ? ""
                : "d-none"
            }
          >
          ...
          <div
            className={
              this.state &&
              this.state.selectedAction == "transcodeKeepOneAudioStream"
                ? ""
                : "d-none"
            }
          >
          ...
          <div
            className={
              this.state && this.state.selectedAction == "remuxContainer"
                ? ""
                : "d-none"
            }
          >
