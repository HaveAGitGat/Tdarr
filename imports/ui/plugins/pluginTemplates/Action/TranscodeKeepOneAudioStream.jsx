  ...
  render() {
    return (
      <div>
        ...
        <center>
          <p>Transcode - Keep one audio stream</p>{" "}
        </center>
        ...
        <p>
          Tdarr will try to keep the best audio track possible given the
          requirements specified below.
        </p>

        <p>
          If the specified stream does not exist, Tdarr will try to create it
          using the best stream available.
        </p>
        <p>
          If no specified language track exists, the best untagged/undefined
          stream will be used/kept.
        </p>
