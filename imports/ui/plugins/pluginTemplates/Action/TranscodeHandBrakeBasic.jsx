...
export default class App extends Component {
  ...
  addAction = () => {
    ...
    var videoEncoder;
    var selectedVideoEncoder = ReactDOM.findDOMNode(this.refs.videoEncoder)
      .value;
  ...
  render() {
    return (
      <div>
        ...
        <center>
          <p>Transcode - HandBrake basic options</p>{" "}
        </center>

        <br />

        <p>
          This action has no built-in filter. It relies on the filters set
          above.{" "}
        </p>
        <p>
          For example,{" "}
          <b>
            if transcoding into hevc (h265), set a filter to exclude hevc or
            your files may be infinitely transcoded.
          </b>
        </p>
        ...
        <select name="preset" ref="preset">
          ...
          <option value="HQ 1080p30 Surround">
            HQ 1080p30 Surround (h264)
          </option>
          ...
          <option value="Super HQ 1080p30 Surround">
            Super HQ 1080p30 Surround (h264)
          </option>
          <option value="Super HQ 720p30 Surround">
            Super HQ 720p30 Surround (h264)
          </option>
          <option value="Super HQ 576p25 Surround">
            Super HQ 576p25 Surround (h264)
          </option>
          <option value="Super HQ 480p30 Surround">
            Super HQ 480p30 Surround (h264)
          </option>
          <option value="Gmail Large 3 Minutes 720p30">
            Gmail Large 3 Minutes 720p30 (h264)
          </option>
          <option value="Gmail Medium 5 Minutes 480p30">
            Gmail Medium 5 Minutes 480p30 (h264)
          </option>
          <option value="Gmail Small 10 Minutes 288p30">
            Gmail Small 10 Minutes 288p30 (h264)
          </option>
          <option value="Vimeo YouTube HQ 2160p60 4K">
            Vimeo YouTube HQ 2160p60 4K (h264)
          </option>
          <option value=">Vimeo YouTube HQ 1440p60 2.5K">
            Vimeo YouTube HQ 1440p60 2.5K (h264)
          </option>
          <option value="Vimeo YouTube HQ 1080p60">
            Vimeo YouTube HQ 1080p60 (h264)
          </option>
          <option value="Vimeo YouTube HQ 720p60">
            Vimeo YouTube HQ 720p60 (h264)
          </option>
          <option value="Vimeo YouTube 720p30">
            Vimeo YouTube 720p30 (h264)
          </option>
          ...
          <option value="Apple 2160p60 4K HEVC Surround">
            Apple 2160p60 4K HEVC Surround (h265)
          </option>
          <option value="Apple 1080p60 Surround">
            Apple 1080p60 Surround (h264)
          </option>
          <option value="Apple 1080p30 Surround">
            Apple 1080p30 Surround (h264)
          </option>
          <option value="Apple 720p30 Surround">
            Apple 720p30 Surround (h264)
          </option>
          <option value="Apple 540p30 Surround">
            Apple 540p30 Surround (h264)
          </option>
          <option value="Apple 240p30">Apple 240p30 (h264)</option>
          <option value="Chromecast 2160p60 4K HEVC Surround">
            Chromecast 2160p60 4K HEVC Surround (h265)
          </option>
          <option value="Chromecast 1080p60 Surround">
            Chromecast 1080p60 Surround (h264)
          </option>
          <option value="Chromecast 1080p30 Surround">
            Chromecast 1080p30 Surround (h264)
          </option>
          <option value="Amazon Fire 2160p60 4K HEVC Surround">
            Amazon Fire 2160p60 4K HEVC Surround (h265)
          </option>
          <option value="Amazon Fire 1080p30 Surround">
            Amazon Fire 1080p30 Surround (h264)
          </option>
          <option value="Amazon Fire 720p30">Amazon Fire 720p30 (h264)</option>
          <option value="Playstation 1080p30 Surround">
            Playstation 1080p30 Surround (h264)
          </option>
          ...
          <option value="Roku 2160p60 4K HEVC Surround">
            Roku 2160p60 4K HEVC Surround (h265)
          </option>
          <option value="Roku 1080p30 Surround">
            Roku 1080p30 Surround (h264)
          </option>
          <option value="Roku 720p30 Surround">
            Roku 720p30 Surround (h264)
          </option>
          <option value="Roku 576p25">Roku 576p25 (h264)</option>
          <option value="Roku 480p30">Roku 480p30 (h264)</option>
          <option value="Windows Mobile 1080p30">
            Windows Mobile 1080p30 (h264)
          </option>
          <option value="Windows Mobile 720p30">
            Windows Mobile 720p30 (h264)
          </option>
          <option value="Windows Mobile 540p30">
            Windows Mobile 540p30 (h264)
          </option>
          <option value="Windows Mobile 480p30">
            Windows Mobile 480p30 (h264)
          </option>
          <option value="Xbox 1080p30 Surround">
            Xbox 1080p30 Surround (h264)
          </option>
          <option value="Xbox Legacy 1080p30 Surround">
            Xbox Legacy 1080p30 Surround (h264)
          </option>
          ...
          <option value="Production Standard">
            Production Standard (h264)
          </option>
          <option value="Production Proxy 1080p">
            Production Proxy 1080p (h264)
          </option>
          <option value="Production Proxy 540p">
            Production Proxy 540p (h264)
          </option>
        </select>
