                ...
                <div className="frame">
                  <div className="scroll">
                    <div className="modalText">
                      <p></p>
                      <p>
                        Copy a {pluginType} plugin id into the 'Plugin ID:'
                        section of one of your libraries. Make sure the '
                        {pluginType}' checkbox is selected.
                      </p>
                      <p></p>
                      <p></p>

                      <p>
                        For information on manually creating community and local
                        plugins, have a look
                      ...
                      <p>
                        ...
                        {this.props && this.props.globalSettings[0]
                          ? this.props.globalSettings[0].homePath.replace(
                              /\\/g,
                              "/"
                            )
                          : null}
                        /Tdarr/Plugins/Community. Any modifications will be
                        overwritten when the plugins are updated.
                      </p>
                      <p>
                        Local plugins are stored in{" "}
                        {this.props && this.props.globalSettings[0]
                          ? this.props.globalSettings[0].homePath.replace(
                              /\\/g,
                              "/"
          ...
          >
            ...
            <TabPanel>
              <div className="tabContainer">
                ...
                <PluginCategory
                  pluginType={"Community"}
                  pluginsStoredFiltered={this.state.pluginsStoredFiltered}
                />
              </div>
            </TabPanel>
                  ...
                  <div className="pluginTabGrid-container">
                    <div className="pluginTabGrid-itemLeft">
                      ...
                      <p
                        ...
                        className={
                          this.state.navSelectedPluginCreatorItem ==
                          "navPluginGuide"
                            ? "selectedNav"
                            : "unselectedNav"
                        }
