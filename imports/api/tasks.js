...
//export const HealthCheckDB = new Mongo.Collection('HealthCheckDB');
...
export const WorkerDB = new Mongo.Collection('workers');
...
if (Meteor.isServer) {
    ...
    Meteor.publish('LogDB', function tasksPublication() {
      ...
      Meteor.publish('WorkerDB', function tasksPublication() {
        return WorkerDB.find();
      });
